...
fn main(mut cx: ModuleContext) -> NeonResult<()> {
    cx.export_function("areaCircle", area_of_circle)?;
    cx.export_function("areaSquar", area_of_squar)?;
    cx.export_function("areaTraingle", area_of_traingle)?;
    cx.export_function("areaHexagon", area_of_hexagon)?;
    cx.export_function("areaPentagon", area_of_pentagon)?;
    cx.export_function("areaTrapezium", area_of_trapezium)?;
    Ok(())
}